/// Custom exception class to handle various Firebase authentication related errrors.
class SkyFirebaseAuthException implements Exception {
  /// The error code associated with the exception.
  final String code;

  /// Constructor that takes an error code.
  SkyFirebaseAuthException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      default:
        return 'Unknown Firebase authentication exception occurred!';
    }
  }
}
